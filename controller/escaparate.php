...
class escaparate extends fbase_controller
{
    ...
    {
        parent::__construct(__CLASS__, 'Escaparate', 'ventas');
    }
    ...
    private function search_articulos()
    {
        ...
        if ($data) {
            ...
            if (isset($_GET['download'])) {
                ...
                $data2 = $this->db->select_limit("SELECT *" . $sql . " ORDER BY " . $order, 20, $this->offset);
                if ($data2) {
                    foreach ($data2 as $i) {
